...
struct User {
    ...
    static var currentUser: User = User(userName: "Biggoat", email: "thegreatest123@gmail.com", age: 95)
 ...
 */
var u = User(userName: "bigdog", email: "TheBiggestDawg@gmail.com", age: 1738)
User.logIn(user: u)
print(User.currentUser)
